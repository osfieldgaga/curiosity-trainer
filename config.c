 ...
 * 
 *  @Summary
 *      Initialization of the board and the background timer using Timer1.
 * 
 *  @Description
 *      The config.c file contains the main initialization and configuration of 
 *      the board. Setting up these registers was done using code generated by 
 *      MCC Configurator. 
 * 
